...
const descriptions: Record<string, [string, string]> = {
  ...
  about: [
    "Tìm hiểu Công ty Luật TNHH Vũ Khang Solutions & Partners: cách tiếp cận vấn đề pháp lý, phạm vi hoạt động và nguyên tắc làm việc với khách hàng.",
  ...
  contact: [
    "Thông tin liên hệ Công ty Luật TNHH Vũ Khang Solutions & Partners: địa chỉ văn phòng, điện thoại và email tiếp nhận yêu cầu.",
  ...
  careers: [
    "Cơ hội nghề nghiệp tại Công ty Luật TNHH Vũ Khang Solutions & Partners: vị trí đang tuyển, nơi làm việc và cách ứng tuyển.",
    "Careers at Vũ Khang: open positions, work locations and how to apply.",
  ],
  privacy: [
    "Cách Công ty Luật TNHH Vũ Khang Solutions & Partners thu thập, sử dụng và bảo vệ thông tin cá nhân của người truy cập website.",
    "How Vũ Khang collects, uses and protects the personal information of visitors to this website.",
  ],
  terms: [
    "Điều khoản sử dụng website của Công ty Luật TNHH Vũ Khang Solutions & Partners, bao gồm giới hạn trách nhiệm đối với nội dung tham khảo.",
