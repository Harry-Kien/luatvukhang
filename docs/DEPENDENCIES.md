...
| @payloadcms/db-postgres         | 3.88.0         | MIT        | runtime     |
| @payloadcms/next                | 3.88.0         | MIT        | runtime     |
| @payloadcms/richtext-lexical    | 3.88.0         | MIT        | runtime     |
| @payloadcms/translations        | 3.88.0         | MIT        | runtime     |
...
| nodemailer                      | 10.0.1         | MIT-0      | runtime     |
| payload                         | 3.88.0         | MIT        | runtime     |
| pg                              | 8.23.0         | MIT        | runtime     |
...
| embedded-postgres               | 18.4.0-beta.17 | MIT        | development |
